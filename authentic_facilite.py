...
def listagem_empresas(token):
    url = "https://adminbackend.facilite.co/api/empresas/lista-custom/pageable?searchable=&page=0&size=4000&sort=dataCriacao,desc&sort=id&isAtivo=true"
